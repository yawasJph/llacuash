...
export const serviceData = [
  {
    ...
    shortDescription: 'Creando aplicaciones web dinámicas e interactivas utilizando JavaScript.',
  },
  {
    icon: ReactIcon,
  ...
  },
  {
    ...
    shortDescription: 'Asegurando un código robusto y mantenible con TypeScript.',
  },
  {
    icon: TailwindCSS,
    title: 'Tailwind CSS Styling',
    shortDescription: 'Diseñando interfaces hermosas y responsivas con Tailwind CSS.',
  },
]
